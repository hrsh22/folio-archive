...
5. **The disappearance test.** Inspect `evidence/recovery/publisher-and-bee-offline.json` and `evidence/hosting/` for completed public recovery after publisher state was removed and publishing services were stopped. Reproduce from a fresh clone with the public verifier.
